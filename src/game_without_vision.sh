...
mate-terminal --tab --title="dummy_main.py" -- bash -c "python internal/src/dummy_main.py; exec bash" 
mate-terminal --tab --title="main.py" -- bash -c "python sawyer_full_stack/src/main.py; exec bash"
