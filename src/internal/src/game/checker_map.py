...
def convert_list_to_custom_game(num_players, players, curr_player, winners, list_of_positions):
    """
    [yellow, ]
    Initializes the board from a custom input which is a list
        input[0]: number of players in the game
    ...
    def helper(height, sliceStart) -> int:
        ...
        rowLength = height_diff_to_row_length_dict[height_diff_to_row_length_dict]
