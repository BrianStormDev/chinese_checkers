...
class ObjectDetector:
    ...
    def process_images(self): # There's an error somewhere here
        ...
        lower_hsv = np.array([68, 104, 118]) # TODO: Define lower HSV values for cup color
        ...
        # Mask is a matrix of nonzeros and zeros
